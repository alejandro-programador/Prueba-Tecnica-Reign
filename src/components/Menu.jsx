...
const Menu = () => {
  ...
  const activeBtn = { borderColor: 'primary.main', color: 'primary.main', width: '10%', textTransform: 'capitalize' };
  const disabledBtn = { borderColor: 'secondary.main', color: 'secondary.dark', width: '10%', textTransform: 'capitalize' };
